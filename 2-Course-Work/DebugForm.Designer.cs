namespace _2_Course_Work
{
    partial class DebugForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.DebugTextBox.Size = new System.Drawing.Size(472, 404);
			...
			this.NameGenreHT_radio.CheckedChanged += new System.EventHandler(this.NameGenreHT_radio_CheckedChanged);
			// 
			// NameAuthorHT_radio
			// 
			...
			this.NameAuthorHT_radio.CheckedChanged += new System.EventHandler(this.NameAuthorHT_radio_CheckedChanged);
			// 
			// YearTree_radio
			// 
			...
			this.YearTree_radio.CheckedChanged += new System.EventHandler(this.YearTree_radio_CheckedChanged);
			// 
			// PublisherTree_radio
			// 
			...
			this.PublisherTree_radio.CheckedChanged += new System.EventHandler(this.PublisherTree_radio_CheckedChanged);
			// 
			// showButton
			// 
